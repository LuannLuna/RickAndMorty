...
public final class FetchCharacterQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Character: GraphQLSelectionSet {
      ...
      public init(name: String? = nil, status: String? = nil, species: String? = nil, type: String? = nil, gender: String? = nil, origin: Origin? = nil, location: Location? = nil, image: String? = nil, episode: [Episode?]) {
        self.init(unsafeResultMap: ["__typename": "Character", "name": name, "status": status, "species": species, "type": type, "gender": gender, "origin": origin.flatMap { (value: Origin) -> ResultMap in value.resultMap }, "location": location.flatMap { (value: Location) -> ResultMap in value.resultMap }, "image": image, "episode": episode.map { (value: Episode?) -> ResultMap? in value.flatMap { (value: Episode) -> ResultMap in value.resultMap } }])
      }
      ...
      public struct Origin: GraphQLSelectionSet {
        ...
        public init(name: String? = nil, dimension: String? = nil, type: String? = nil) {
          self.init(unsafeResultMap: ["__typename": "Location", "name": name, "dimension": dimension, "type": type])
        }
